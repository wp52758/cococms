            ...
            <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="title" name="title" required="" lay-verify="title" autocomplete="off"
                               class="layui-input input_width" value="{{ $article['title'] }}">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="abstract" name="abstract" required="" lay-verify="abstract"
                               autocomplete="off" class="layui-input input_width" value="{{ $article['abstract'] }}">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="keyword" name="keyword" required="" lay-verify="keyword"
                               autocomplete="off" class="layui-input input_width" value="{{ $article['keyword'] }}">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        ...
                        <img  src="{{ $article['main_pic'] }}" style="margin-top: 20px; width: 300px;  @if(empty($article['main_pic'])) display: none @endif">
                ...
                <div class="layui-form-item">
                <label for="group_pic" class="layui-form-label">组图</label>
                <div class="layui-input-inline">
                <button type="button" class="layui-btn" id="L_group_pic" required="" lay-verify="group_pic" autocomplete="off">
                    <i class="layui-icon">&#xe67c;</i>上传图片
                </button>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="link" name="link" required="" lay-verify="link"
                               autocomplete="off" class="layui-input" value="{{ $article['link'] }}">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <div class="layui-input-inline">
                            <input type="radio" name="is_release" value="0" title="否" @if($article['is_release'] == 0) checked @endif>
                            <input type="radio" name="is_release" value="1" title="是" @if($article['is_release'] == 1) checked @endif>
                        </div>
                    </div>
                </div>
        ...
        function () {
            ...
            form.on('submit(add)',
                function (data) {
                    console.log(data);
                    //发异步，把数据提交给php
                    AjaxPost('/admin/article/edit/{{ $article['id'] }}',data.field,function (data) {
                        console.log(data);
