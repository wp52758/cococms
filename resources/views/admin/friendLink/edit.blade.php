            ...
            <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="name" name="name" required="" lay-verify="name" autocomplete="off"
                               class="layui-input input_width" value="{{ $friendLink['name'] }}">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        ...
                        <img  src="{{ $friendLink['logo'] }}" style="margin-top: 20px; width: 300px; ">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="url" name="url" required="" lay-verify="url"
                               autocomplete="off" class="layui-input input_width" value="{{ $friendLink['url'] }}">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <div class="layui-input-inline">
                            <input type="radio" name="is_public" value="0" title="否" @if($friendLink['is_public'] == 0) checked @endif>
                            <input type="radio" name="is_public" value="1" title="是" @if($friendLink['is_public'] == 1) checked @endif>
                        </div>
                    </div>
                </div>
        ...
        function () {
            ...
            form.on('submit(add)',
                function (data) {
                    console.log(data);
                    //发异步，把数据提交给php
                    AjaxPost('/admin/friendLink/edit/{{ $friendLink['id'] }}',data.field,function (data) {
                        console.log(data);
