                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="user_name" name="user_name" required="" lay-verify="user_name" autocomplete="off"
                               class="layui-input input_width" value="{{ $admin['user_name'] }}">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="email" name="email" required="" lay-verify="email"
                               autocomplete="off" class="layui-input input_width" value="{{ $admin['email'] }}">
                    </div>
                </div>
                    ...
                    <div class="layui-input-block">
                        ...
                        @foreach($roles as $val)
                            <input type="checkbox" name="roles[]" value="{{ $val['id'] }}"
                                   @if(in_array($val['id'],$usedRoles)) checked @endif
                                   lay-skin="primary" title="{{ $val['role_name'] }}">
                        @endforeach
        ...
        function () {
            ...
            form.on('submit(add)',
                function (data) {
                    console.log(data);
                    //发异步，把数据提交给php
                    AjaxPost('/admin/admin/edit/{{ $admin['id'] }}',data.field,function (data) {
                        console.log(data);
