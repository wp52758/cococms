    ...
    <div class="layui-row">
        <form class="layui-form">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="radio" name="type" value="1" title="列表" @if(empty($category['type']) || $category['type'] == 1) checked @endif>
            ...
            <div class="layui-form-item">
                ...
                <button type="button" class="layui-btn" id="L_pic" required="" lay-verify="pic" autocomplete="off">
                    <i class="layui-icon">&#xe67c;</i>上传图片
                </button>
                <input type="hidden" id="i_pic" name="pic" value="{{ $category['pic'] }}">
                <img id="pic" src="{{ $category['pic'] }}" style="margin-top: 20px; width: 300px; @if(empty($category['pic'])) display: none @endif">
            </div>
